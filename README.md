...
- **Delete**: `DELETE "/api/v1/assignments?actorId={?}&userId={?}&productId={?}"` -- удаление всех связей между указанными пользователем и продуктом (права только у админов), соответствует методу deleteAssignments
